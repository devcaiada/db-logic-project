...
INSERT INTO `clients` VALUES (1,'Maria','M','Silva','12346789','rua silva de prata 29, Carangola - Cidade das flores','PJ'),(2,'Matheus','O','Pimentel','987654321','rua alemeda 289, Centro - Cidade das flores','PJ'),(3,'Ricardo','F','Silva','45678913','avenida alemeda vinha 1009, Centro - Cidade das flores','PJ'),(4,'Julia','S','França','789123456','rua lareijras 861, Centro - Cidade das flores','PJ'),(5,'Roberta','G','Assis','98745631','avenidade koller 19, Centro - Cidade das flores','PJ'),(6,'Isabela','M','Cruz','654789123','rua alemeda das flores 28, Centro - Cidade das flores','PJ'),(7,'Caio','P','Arruda','12345678910','Rua das dores, 42','PF');
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`idOrder`),
  KEY `idx_order_client` (`idOrderClient`),
...
--
-- Temporary view structure for view `vw_available_products`
--

DROP TABLE IF EXISTS `vw_available_products`;
/*!50001 DROP VIEW IF EXISTS `vw_available_products`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_available_products` AS SELECT 
 1 AS `idProduct`,
 1 AS `Pname`,
 1 AS `category`,
 1 AS `avaliação`,
...
/*!50001 VIEW `view_clients` AS select `clients`.`idClient` AS `idClient`,concat(`clients`.`Fname`,' ',`clients`.`Minit`,'.',' ',`clients`.`Lname`) AS `Nome`,`clients`.`CPF` AS `CPF`,`clients`.`Address` AS `Endereco`,`clients`.`ClientType` AS `Tipo` from `clients` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_available_products`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_available_products` AS select `product`.`idProduct` AS `idProduct`,`product`.`Pname` AS `Pname`,`product`.`category` AS `category`,`product`.`avaliação` AS `avaliação`,`product`.`size` AS `size` from `product` where (`product`.`classification_kids` = false) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-09-16 11:45:34
